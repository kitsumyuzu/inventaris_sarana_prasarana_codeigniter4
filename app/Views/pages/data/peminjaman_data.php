                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card">
                                    ...
                                    <form action="/inventaris/insert_peminjaman/" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="col-md-12 p-0">
                                                        ...
                                                        <select class="form-control" name="nama_barang" required>
                                                            ...
                                                            <?php foreach ($inventarisData as $data) { ?>

                                                                <option value="<?php echo $data -> id_inventaris ?>"><?php echo ucwords($data -> nama) ?></option>
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="col-md-12 p-0">
                                                        ...
                                                        <input class="form-control" type="number" name="jumlah" placeholder="Jumlah peminjaman" required min="1">
                                                        ...
                                                        <div class="col-md-12 p-0">
                                                            ...
                                                            <select class="form-control" name="pegawai" required>
                                                                ...
                                                                <?php foreach ($pegawaiData as $data) { ?>
                                                                    ...
                                                                    <option value="<?php echo $data -> id_pegawai ?>"><?php echo ucwords($data -> nama_depan . " " . $data -> nama_belakang) ?></option>
                                                        ...
                                                        <tr style="text-align: center;">
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?= base_url('/user/view_update_user/'.$data -> id_petugas) ?>">
                                                                    ...
                                                                    <button type="button" data-toggle="tooltip" class="btn btn-link btn-danger btn-sm" data-original-title="Change Status"><i class="fas fa-chart-simple fa-xl"></i></button>
