                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card">
                                    ...
                                    <form action="/inventaris/insert_jenis/" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="col-md-12 p-0">
                                                        ...
                                                        <input class="form-control" type="text" name="nama_jenis" placeholder="Nama Jenis" required maxlength="225">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <div class="col-md-12 p-0">
                                                        ...
                                                        <input class="form-control" type="text" name="kode_jenis" placeholder="Kode Jenis" required maxlength="225">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr style="text-align: center;">
                                                            ...
                                                            <td><?php echo ucwords($data -> kode_jenis ? $data -> kode_jenis : '-') ?></td>
                                                            <td><?php echo ucwords($data -> keterangan ? $data -> keterangan : '-') ?></td>

                                                            <td width="20%">

                                                                <a href="<?= base_url('/inventaris/delete_jenis/'.$data -> id_jenis) ?>">
